#!/bin/sh
# This script generates a new C++ project, complete with google test program
# code and makefile.
# USAGE: ./setup_cpp_snippet.sh SNIPPET_TYPE PROJECT_NAME
...
${PROJECT_NAME}.o : \$(USER_DIR)/${PROJECT_NAME}.cc \\
	                       \$(USER_DIR)/${PROJECT_NAME}.h \$(GTEST_HEADERS)
	\$(CXX) \$(CPPFLAGS) -c \$(USER_DIR)/${PROJECT_NAME}.cc
...
cat << _EOF_ > "${PROJECT_DIR}/${PROJECT_NAME}.cc"
/******************************************************************************
